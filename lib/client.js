window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const ICON_GIT = ["M5.5 3.5v6M5.5 9.5a2 2 0 0 0 2 2h2.5", "M10 3.5v4a2 2 0 0 0 2 2", "M5.5 3.5a1.25 1.25 0 1 0-2.5 0 1.25 1.25 0 0 0 2.5 0z", "M12.5 3.5a1.25 1.25 0 1 0-2.5 0 1.25 1.25 0 0 0 2.5 0z"];
    const ICON_SERVER = ["M3.5 4.5h9", "M3.5 8h9", "M3.5 11.5h9", "M5 4.5v0M5 8v0M5 11.5v0"];
    const ICON_SKILLS = ["M3.5 3h9a1 1 0 0 1 1 1v8.5a1.5 1.5 0 0 0 1.5 1.5H5a1.5 1.5 0 0 1-1.5-1.5z", "M3.5 3.5V13"];
