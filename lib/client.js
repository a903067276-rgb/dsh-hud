  ...
  factory: (require) => {
    ...
    function HudSettingsCard() {
      ...
      return react.createElement("div", { style: { display: "flex", flexDirection: "column", gap: "8px" } },
        ...
        react.createElement("h3", { style: { margin: 0, fontSize: 14, fontWeight: 600, color: "var(--dsw-alias-label-primary)" } }, "HUD"),
    ...
    if (slots !== undefined) {
      ...
      slots.inject("settings.plugin.item", () => slots.register(
        { name: "settings.plugin.item", key: "dsh-hud", id: "dsh-hud" },
        () => react.createElement(HudSettingsCard)
      ));
    }
    }
