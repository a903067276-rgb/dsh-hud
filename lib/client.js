    ...
    function apply(ctx) {
      ...
      slots.inject("conversation.input.left", () => slots.register(
        ...
        (props) => {
          ...
          const fromProps = typeof useSessions === "function" ? useSessions((s) => s && s.current) : undefined;
          ...
          const current = typeof snap.sessionId === "string" && snap.sessionId !== ""
            ? snap.sessionId
            : (typeof fromProps === "string" && fromProps !== "" ? fromProps : undefined);
