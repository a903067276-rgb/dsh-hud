window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function HudSettingsCard() {
      ...
      // 保存反馈（2026-08-20 补）：按钮短暂变"已保存"，2 秒后复原；连点只保留最后一个计时器
        ...
        (props) => {
                ...
                return react.createElement("div", { key: gkey },
                  react.createElement("div", {
                    ...
                    style: {
                      ...
                      fontSize: "11px", color: "var(--dsw-alias-text-tertiary, #999)",
          ...
          return react.createElement("div", {
            ...
            react.createElement("div", {
              ...
              react.createElement("span", { style: { fontSize: "11px", color: "var(--dsw-alias-text-tertiary, #999)" } },
