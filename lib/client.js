        ...
        (props) => {
          ...
          return react.createElement("div", {
            style: {
              ...
              borderRadius: "10px",
              boxShadow: "var(--dsw-shadow-lv2, 0 4px 16px rgba(0,0,0,0.12))",
                    ...
                    react.createElement("div", null,
                      react.createElement("div", { style: { fontSize: "12px", fontWeight: 500 } },
                        ...
                        (git.ahead > 0 || git.behind > 0)
                          ? react.createElement("span", { style: { color: "var(--dsw-alias-label-tertiary)", fontWeight: 400, marginLeft: "5px" } }, "↑" + git.ahead + " ↓" + git.behind)
                          : null,
                        git.files.length > 0
                          ? react.createElement("span", { style: { color: "var(--dsw-alias-state-warn-primary)", marginLeft: "5px" } }, git.files.length + " 个未提交")
